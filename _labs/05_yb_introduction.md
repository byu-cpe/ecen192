...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/Traces.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/iniFile.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/cloneRepo.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/Extensions.png %}" width="250"/>
</p>

2. Search for platformio and install the first one

<p align = "center">
<img src="{% link /assets/05_yb_introduction/platformIO.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/openProject.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/functions.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/uploadBottom.png %}" width="250"/>
</p>

<p align = "center">
<img src="{% link /assets/05_yb_introduction/UploadTop.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/labelLED.png %}" width="250"/>
</p>

If the screen isn’t already set up. Plug in the corresponding jumpers:

<p align = "center">
<img src="{% link /assets/05_yb_introduction/gpio.png %}" width="250"/>
</p>

As labeled on the oled display:

<p align = "center">
<img src="{% link /assets/05_yb_introduction/oled.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/tempSensor.png %}" width="250"/>
</p>

A photo reference for which led corresponds to which component:

<p align = "center">
<img src="{% link /assets/05_yb_introduction/hardwareTestReference.png %}" width="250"/>
</p>

## 🔎 Troubleshooting

<p align = "center">
<img src="{% link /assets/05_yb_introduction/troubleshootingSucess.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/troubleshootingSerialException.png %}" width="250"/>
</p>

or

<p align = "center">
<img src="{% link /assets/05_yb_introduction/troubleshootingNoSerialData.png %}" width="250"/>
</p>
...
<p align = "center">
<img src="{% link /assets/05_yb_introduction/troubleshootingSpecifyPort.png %}" width="250"/>
</p>

Remember to turn the board on and plug it into the computer you’re using before trying to upload code.

<p align = "center">
<img src="{% link /assets/05_yb_introduction/troubleshootingPortNotExist.png %}" width="250"/>
</p>
